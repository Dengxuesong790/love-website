...
DEFAULT_CONFIGS = {
    ...
    # 情书历史记录（多封，按展示顺序排列，最新在前）
    'letter.list': json.dumps([
        {
            'title': '致我最爱的王斐',
            'date': '2026-08-18',
            'content': (
        ...
        },
        {
            ...
            'content': (
                '亲爱的斐：\n\n'
                '提笔写这封信的时候，我的心里满是你的身影。从遇见你的那一刻起，我的世界就变得不一样了。\n\n'
                '还记得我们第一次相见的那天吗？那是 2026 年 3 月 8 日，阳光正好，微风不燥，'
                '而你笑着向我走来的样子，成为了我记忆中最美的画面。从那天开始，我的心跳就为你而加速。\n\n'
                '我们一起度过了那么多美好的时光：第一次约会的紧张与期待，每一次牵手的心动，'
                '每一次相视而笑的温暖。这些点点滴滴的片段，构成了我生命中最珍贵的回忆。\n\n'
                '2026 年 4 月 11 日，是我人生中最重要的一天。因为从那天起，我有了你，'
                '你成了我的恋人，成了我想要守护一生的人。\n\n'
                '我想告诉你，我对你的爱意，藏在每一个清晨的问候里，藏在每一次温柔的注视里，'
                '藏在每一份用心的陪伴里。我爱你，不仅仅是一时的冲动，'
                '而是经过时间沉淀后依然坚定的选择。\n\n'
                '未来的日子里，我想和你一起看遍世间美景，尝遍人间美食，经历人生的喜怒哀乐。'
                '我想在每一个清晨醒来都能看到你的睡颜，在每一个夜晚都能拥你入眠。\n\n'
                '你在身边，在我身边，岁岁年年。这就是我最大的幸福，也是我最美的期待。'
            ),
            'signature': '永远爱你的\n邓雪松'
        }
    ], ensure_ascii=False),
